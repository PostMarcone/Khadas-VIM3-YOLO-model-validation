...
parser.add_argument("--mdl", help="Name of the subdirectory to use inside detection-results")
parser.add_argument("--minoverlap", type=float, default=0.5, help="IoU threshold")
parser.add_argument("--sp", action="store_true", help="Show plot graphs")
...
DR_PATH = os.path.join(os.getcwd(), 'input', 'detection-results', args.mdl)
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'input', 'images-optional')
# Added to not annoy me
...
output_files_path = "output" + "/" + args.mdl + "/" + "mAP" + str(args.minoverlap)
#output_files_path = "output" + "/" + args.mdl
