...
vsi_nn_graph_t * vnn_CreateYoloModel
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Transpose_Transpose_200/out0_0:out0 */
    attr.size[0] = 82;
    attr.size[1] = 60;
    attr.size[2] = 60;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.5854508876800537;
    attr.dtype.zero_point = 222;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[0], attr, VSI_NN_TYPE_UINT8);

    /* @attach_Transpose_Transpose_216/out0_1:out0 */
    attr.size[0] = 82;
    attr.size[1] = 30;
    attr.size[2] = 30;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.579534649848938;
    attr.dtype.zero_point = 222;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[1], attr, VSI_NN_TYPE_UINT8);

    /* @attach_Transpose_Transpose_232/out0_2:out0 */
    attr.size[0] = 82;
    attr.size[1] = 15;
    attr.size[2] = 15;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.6639921069145203;
    attr.dtype.zero_point = 235;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.003921560011804104;
...
error:
    ...
    vnn_ReleaseYoloModel( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYoloModel() */

void vnn_ReleaseYoloModel
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
